...
function badgeLabel(badge: string) {
  switch (badge) {
    ...
    case "bug_hunter":
      return "Bug Hunter";
    case "bug_hunter_lvl_2":
      return "Golden Bug Hunter";
    default:
      return badge;
  }
}
          ...
          <div class="profile-card__name-row">
            ...
            <div v-if="badges.length" class="profile-card__badges">
              <span v-for="badge in badges" :key="badge" class="profile-card__badge"
                ...
                <img v-if="badge === 'system'" class="profile-card__badge-icon"
                  :src="messenger.profileImageSrc(profile.avatar, 'avatar')" alt="" aria-hidden="true" />
                <svg v-else-if="badge === 'admin' || badge === 'staff'" height="24" viewBox="0 0 24 24" width="24"
                ...
                <svg v-else-if="badge === 'mod'" height="24" viewBox="0 0 24 24" width="24"
                  xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path
                ...
                <svg v-else-if="badge === 'early'" height="24" viewBox="0 0 24 24" width="24"
                  xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path
                ...
                <svg v-else-if="badge === 'vip'" height="24" viewBox="0 0 24 24" width="24" fill="none"
                  xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <svg v-else-if="badge === 'contributor'" height="24" viewBox="0 0 24 24" width="24"
                  xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <g fill="#5865f2">
                    <path
                ...
                <svg v-else-if="badge === 'artist'" height="24" viewBox="0 0 24 24" width="24"
                  xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <g fill="#fbb848">
                    <path
                ...
                <svg v-else-if="badge === 'bug_hunter'" height="24" viewBox="0 0 24 24" width="24"
                  xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path
                ...
                <svg v-else-if="badge === 'bug_hunter_lvl_2'" class="badge-icon" viewBox="0 0 24 24"
                  aria-hidden="true">
                ...
                <span v-else class="profile-card__badge-custom" aria-hidden="true">{{ badge.slice(0, 2).toUpperCase()
                  }}</span>
              </span>
            </div>
          </div>
